...
k_sz = int(39*6/5)
print(k_sz)
big_kernel = np.zeros((k_sz, k_sz))
make_kernel_circle(0.46*k_sz, k_sz, 1.0*scaler, big_kernel)
make_kernel_circle(0.44*k_sz, k_sz, 1.0*scaler, big_kernel)
make_kernel_circle(0.38*k_sz, k_sz, -1.8*scaler, big_kernel)
make_kernel_circle(0.31*k_sz, k_sz, 1.0*scaler, big_kernel)
make_kernel_circle(0.28*k_sz, k_sz, 1.0*scaler, big_kernel)
make_kernel_circle(0.23*k_sz, k_sz, -1.8*scaler, big_kernel)

plt.imshow(big_kernel, interpolation='nearest')
plt.show()
